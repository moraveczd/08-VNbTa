...
\frame{
	...
	\begin{columns}
		...
		\item Nejstabilnějším izotopem je \ce{^{268}Db} s~poločasem rozpadu 30,8~hodin.\footnote[frame]{\href{https://doi.org/10.1016/j.nuclphysa.2006.12.060}{Chemical Identification of a Long-Lived Isotope of Dubnium, a Descendant of Element 115}}
		\end{itemize}
		\end{column}
		\begin{column}{.3\textwidth}
			\begin{figure}
				\includegraphics[height=.65\textheight]{img/Dubna_Collage.jpg}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.5\textheight]{img/Patronite.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{figure}
			\adjincludegraphics[width=\textwidth]{img/Vanadinite.jpg}
		\end{figure}
		\end{column}

		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Vanadinit2.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.8\textwidth]{img/Columbite-162793.jpg}
			\end{figure}
		\end{column}

		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.8\textwidth]{img/Columbite-75444.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=.8\textwidth]{img/Samarskite-75446.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Hlavní využití nachází vanad jako příměs do ocelí (ferrovanad).
		...
		\item Nejběžnějším typem je FeV80, která obsahuje 80~\% vanadu.
		...
		\item \ce{3 V2O5 + 10 Al -> 6 V + 5 Al2O3}
		\item \ce{2 V2O5 + 5 Si + 10 CaO -> 4 V + 5 Ca2SiO4}
		\item \ce{V_x + Fe_{1-x} -> (Fe_{1-x}V_x)}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/Apollo_CSM_lunar_orbit.jpg}
		\caption*{Apollo 15 CSM}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Jaderný izomer \textbf{\ce{$^{93m}$Nb}} se připravuje ozařováním stabilního izotopu \ce{$^{93}$Nb} rychlými neutrony v jaderném reaktoru:
		...
		\item Izomer \ce{$^{93m}$Nb} se využívá jako zdroj RTG záření pro rentgenovou fluorescenci (XRF).\footnote[frame]{\href{https://doi.org/10.1016/0883-2889(90)90184-I}{The possibility of \ce{$^{93m}$Nb} radionuclide production in the nuclear reactor BR-10 ...}}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.55\textheight]{img/Tantal-P1100196c.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.2\textheight]{img/Parallel_plate_capacitor.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/Tantalum_Capacitor_Production_Flow.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item S $\pi$-akceptorními ligandy vytváří i komplexní sloučeniny, kde vystupují v oxidačním čísle 0.
...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Cavansite-121680.jpg}
				\caption*{Canvasit}
			\end{figure}
		\end{column}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Pentagonite-177796.jpg}
				\caption*{Pentagonit}
			\end{figure}
		\end{column}
	\end{columns}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=.4\textheight]{img/V2O5.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Struktura dekavanadičnanu \ce{[V10O28]^{6-}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.8\textheight]{img/VinwaterPourbaixdiagram.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Krystalizací můžeme získat soli \ce{K8M6O19.16H2O}.
...
\frame{
	...
	\begin{column}{.4\textwidth}
	\begin{figure}
		\adjincludegraphics[width=\textwidth]{img/VF5-xtal.png}
	\end{figure}
	\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.75\textheight]{img/VF4-xtal.png}
		\caption*{Krystalová struktura \ce{VF4}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.3\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/VCl4-2THF.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\begin{columns}
		...
		\item Vanad se v nich vyskytuje jako \textit{amavadinový anion}, obsahuje vanad v ocxidačním stavu IV, který je chelatován dvěma anionty kyseliny N-hydroxyimino-2,2'-dipropionové.
	\end{itemize}
		\end{column}
	\begin{column}{.4\textwidth}
		\begin{figure}
